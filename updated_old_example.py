...
# image1.jpg
# image2.jpg
# If you want to test the code with your imageuis, just add path to the images to the TEST_IMAGE_PATHS.
PATH_TO_TEST_IMAGES_DIR = 'test_images/images'
TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, 'image{}.jpg'.format(i)) for i in range(7, 9) ]  # change this value if you want to add more pictures to test
